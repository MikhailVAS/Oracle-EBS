/*
 ...
 Purpose : This plsql program is used to insert data into PO interface table to create Standard
           Purchase Order through PDOI having Contract as reference 
...
-- Provide the list of contract header ids 
l_contract_id_tbl   PO_TBL_NUMBER := PO_TBL_NUMBER(105467); -- test CPA 6000
...
BEGIN
 ...
 ---- Inserting into header interface table
  ...
  ( po_headers_interface_s.NEXTVAL,--- INTERFACE_HEADER_ID, 
   ...
   FOR i  IN 1..l_contract_id_tbl.COUNT LOOP
