/*
 ...
 Purpose : This plsql program is used to insert data into PO interface table to create Standard
           Purchase Order through PDOI having GBPA as reference
...
-- Provide the list of from_header_id list and corresponding line id list
l_from_header_id_tbl PO_TBL_NUMBER := PO_TBL_NUMBER(105462,105462);
l_from_line_id_tbl PO_TBL_NUMBER := PO_TBL_NUMBER(165078, 165079); 
...
BEGIN
 ...
 ---- Inserting into header interface table
  ...
  ( po_headers_interface_s.NEXTVAL,--- INTERFACE_HEADER_ID, 
   ...
   FOR i  IN 1..l_from_header_id_tbl.COUNT LOOP
  ...
  Insert into PO.PO_LINES_INTERFACE
   ...
   Values
     ...
     'ADD',--- ACTION,  
       l_from_header_id_tbl(i),
       l_from_line_id_tbl(i),
