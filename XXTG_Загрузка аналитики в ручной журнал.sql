...
SELECT * FROM xxtg_gl001_double_global dg WHERE dg.D_DOC_NUM LIKE '%Бухгалтерская справка  '

SELECT * FROM xxtg_gl001_double_global dg WHERE dg.D_DOC_NUM ='Исправление аналитики по бухг.справке  (4)'
...
UPDATE xxtg_gl001_double_global SET 
   ...
   c_an_desc_3='50025  Контрольный (ид.) знак '|| CHR(039) || 'Моб.Тел.' || CHR(039) || '(импорт), 17х18'
